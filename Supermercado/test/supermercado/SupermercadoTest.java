...
public class SupermercadoTest {
	...
	public void testCantidadDeProductos() {
		assertEquals(0, supermercado.cantidadDeProductos(),0);
		supermercado.agregarProducto(arroz);
		supermercado.agregarProducto(detergente);
		assertEquals(2, supermercado.cantidadDeProductos(),0);
	}
	
	@Test
	public void testPrecioTotal() {
		assertEquals(new Double(0), supermercado.precioTotal(),0);
		supermercado.agregarProducto(arroz);
		supermercado.agregarProducto(detergente);
		assertEquals(new Double(93.9), supermercado.precioTotal(),0);
	}
}
